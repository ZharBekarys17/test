...
//   //   }
//   // }
//   let prodimg = productsList[index]
//   return(
      ...
      <main>
        ...
        <div className='products'>
            {productsList.map((product, index) => (
              ...
              {/* onClick={() => setIndex(product.images[index] - 1) } */}
                <button className='slider-control'  onClick={Next}>
                  <ChevronLeftIcon />
                </button>
                <img src={product.thumbnail} alt={product.brand} />
                {/* onClick={() => setIndex(product.images[index] + 1)} */}
                <button className='slider-control' onClick={Previous}>
                  <ChevronRightIcon />
                </button>
              </div>
              <div className='info'>
                  ...
                  <p>{textLen(product.description)}</p>
              </div>
              </div>
            ))}
        </div>
...
function textLen(text, length = 18) {
